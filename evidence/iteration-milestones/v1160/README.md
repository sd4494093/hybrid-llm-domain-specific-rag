# v1160: Located Evidence

## Read Actual Evidence

[Open paginated results, case verdicts, and explicit gaps](../../review/v1151-v1200/v1160/README.md). 0 path-associated artifacts have public test content.

Coverage: `located_references`. This version has 19 path-associated artifacts, 44 document references, and 0 commit-subject references.

Path mentions can identify a comparator, schema or question-set revision. They are not proof of a tested implementation.

[Reference IDs](../../iterations/v1160.json) | [Full history](../../ITERATION_HISTORY.md)
