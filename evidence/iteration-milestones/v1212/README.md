# v1212: Located Evidence

Coverage: `located_references`. This version has 39 path-associated artifacts, 48 document references, and 0 commit-subject references.

Path mentions can identify a comparator, schema or question-set revision. They are not proof of a tested implementation.

[Reference IDs](../../iterations/v1212.json) | [Full history](../../ITERATION_HISTORY.md)
