# v1183: Located Evidence

Coverage: `located_references`. This version has 40 path-associated artifacts, 46 document references, and 1 commit-subject references.

Path mentions can identify a comparator, schema or question-set revision. They are not proof of a tested implementation.

[Reference IDs](../../iterations/v1183.json) | [Full history](../../ITERATION_HISTORY.md)
