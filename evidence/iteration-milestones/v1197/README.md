# v1197: Located Evidence

Coverage: `located_references`. This version has 82 path-associated artifacts, 45 document references, and 0 commit-subject references.

Path mentions can identify a comparator, schema or question-set revision. They are not proof of a tested implementation.

[Reference IDs](../../iterations/v1197.json) | [Full history](../../ITERATION_HISTORY.md)
