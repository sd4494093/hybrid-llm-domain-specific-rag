# v1165: Located Evidence

Coverage: `located_references`. This version has 55 path-associated artifacts, 143 document references, and 1 commit-subject references.

Path mentions can identify a comparator, schema or question-set revision. They are not proof of a tested implementation.

[Reference IDs](../../iterations/v1165.json) | [Full history](../../ITERATION_HISTORY.md)
