# v1545: Located Evidence

## Read Actual Evidence

[Open paginated results, case verdicts, and explicit gaps](../../review/v1501-v1550/v1545/README.md). 1 path-associated artifacts have public test content.

Coverage: `located_references`. This version has 1 path-associated artifacts, 0 document references, and 0 commit-subject references.

Path mentions can identify a comparator, schema or question-set revision. They are not proof of a tested implementation.

[Reference IDs](../../iterations/v1545.json) | [Full history](../../ITERATION_HISTORY.md)
