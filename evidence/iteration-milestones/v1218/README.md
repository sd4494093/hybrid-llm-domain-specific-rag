# v1218: Located Evidence

Coverage: `located_references`. This version has 126 path-associated artifacts, 107 document references, and 0 commit-subject references.

Path mentions can identify a comparator, schema or question-set revision. They are not proof of a tested implementation.

[Reference IDs](../../iterations/v1218.json) | [Full history](../../ITERATION_HISTORY.md)
